...
export default {
    ...
    created(){},//quando é criado o componente
    destroyed(){},
    activated(){},//quando é ativado o componente // Só funciona quando tiver o <keep-alive>
    deactivated(){},//quando é desativado o componente // Só funciona quando tiver o <keep-alive>
}
</script>
